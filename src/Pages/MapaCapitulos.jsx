      ...
      <div className="Container-mapa">
        ...
        <div className="card-capitulo">
          <div className="card-overlay">
            <p className="capitulo-numero">CAPÍTULO I</p>

            <h2 className="capitulo-titulo">
              LA ENTRADA
            </h2>

            <div className="linea-card"></div>

            <p className="capitulo-descripcion">
              Un visitante nocturno llega al museo, buscando respuestas...
              pero lo que encuentra es el inicio de algo mucho más oscuro.
            </p>
